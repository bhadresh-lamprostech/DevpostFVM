...
const config = {
    ...
    networks: {
        ...
        "filecoin-hyperspace": {
            url: `https://rpc.ankr.com/filecoin_testnet/${(_l = process.env.FILECOIN_HYPERSPACE_API_KEY) !== null && _l !== void 0 ? _l : ""}`,
            accounts: process.env.FILECOIN_HYPERSPACE_PRIVATE_KEY !== undefined
